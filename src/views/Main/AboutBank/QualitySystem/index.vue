			...
			<div class="app-view-content">
				<v-row>
					<v-col md="5" class="pt-8">
						<h2 class="font-600 dark-text">{{ $t("TariffsAndConditions.for_download") }}</h2>

						<v-divider style="border-color: rgba(var(--border-color), 1)" class="mt-5 mb-8"></v-divider>

						<template>
							<a
								href="https://back.asakabank.uz/media/files/audit1.pdf"
								target="_blank"
							...
							>
								<div class="d-flex align-center">
									...
									<div class="flex-1">
										<h3 class="dark-text font-600">{{ $t("LastCorrections.audit1") }}</h3>
									</div>

									<div class="download-icon pr-10 transition-all">
										<download-icon size="1.8x" class="custom-class"></download-icon>
									</div>
								</div>
							</a>
						</template>
						...
						<template>
							<a
								href="https://back.asakabank.uz/media/files/audit2.pdf"
								target="_blank"
								rel="noopener noreferrer"
								download
								class="
							...
							>
								<div class="d-flex align-center">
									...
									<div class="flex-1">
										<h3 class="dark-text font-600">{{ $t("LastCorrections.audit2") }}</h3>
									</div>
						...
						<template>
							<a
								:href="$i18n.locale === 'uz' ? 'https://back.asakabank.uz/media/files/SCAN0080uz.PDF'
																: $i18n.locale === 'ru' ? 'https://back.asakabank.uz/media/files/SCAN0081ru.PDF'
																	: 'https://back.asakabank.uz/media/files/SCAN0081en.PDF'"
								target="_blank"
								rel="noopener noreferrer"
								download
								class="
							...
							>
								<div class="d-flex align-center">
									...
									<div class="flex-1">
										<h3 class="dark-text font-600">{{ $t("LastCorrections.audit3") }}</h3>
									</div>
					...
					<v-col md="6">
						<v-responsive :aspect-ratio="1.1">
							<img
								...
								class="p-absolute w-100 h-100 img-cover"
								style="right: 0"
							/>
						</v-responsive>
					</v-col>
