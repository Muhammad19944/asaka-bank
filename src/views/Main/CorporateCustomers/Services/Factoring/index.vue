<template>
	<div class="project-financing-view">
		<v-container>
			...
			<div class="app-view-content mt-16">
				<h2 class="font-600 dark-text">{{ $t('factoring_text_5') }}</h2>
						...
						<template>
							...
							>
								<div class="d-flex align-center">
									...
									<div class="flex-1">
										<h3 class="dark-text font-600">{{ $t('factoring_text_6') }}</h3>
									</div>
								</div>
							</a>
						</template>
						...
						<template>
							...
							>
								<div class="d-flex align-center">
									...
									<div class="flex-1">
										<h3 class="dark-text font-600">{{ $t('factoring_text_7') }}</h3>
									</div>
								</div>
							</a>
						</template>
						...
						<template>
							...
							>
								<div class="d-flex align-center">
									...
									<div class="flex-1">
										<h3 class="dark-text font-600">{{ $t('factoring_text_8') }}</h3>
									</div>
								</div>
							</a>
						</template>
						...
						<template>
							...
							>
								<div class="d-flex align-center">
									...
									<div class="flex-1">
										<h3 class="dark-text font-600">{{ $t('factoring_text_9') }}</h3>
									</div>
								</div>
							</a>
						</template>
						...
						<template>
							...
							>
								<div class="d-flex align-center">
									...
									<div class="flex-1">
										<h3 class="dark-text font-600">{{ $t('factoring_text_10') }}</h3>
									</div>
								</div>
							</a>
						</template>
