<template>
	<div class="credits-list-view">
		<div class="view-toolbar mt-16">
			<v-container class="pa-0">
				<div class="app-tab-header px-5 d-flex">
					<div class="tab-header-items text-center active" data-navigation="items">
						<router-link :to="{name: 'CardListType', params: { type: 'all' }}"
							class="navigation-link navigation-link__hover text-decoration-none p-relative text--h4 py-6 font-600 d-inline-block mr-8"
						>
							<I18nVue t="Cards.all_cards" />
						</router-link>
					</div>
					<div class="tab-header-items text-center" data-navigation="items">
						<router-link :to="{name: 'CardListType', params: { type: 'uzcard' }}"
							class="navigation-link navigation-link__hover text-decoration-none p-relative text--h4 py-6 font-600 d-inline-block mr-8"
						>
							<I18nVue t="Cards.uz_card" />
						</router-link>
					</div>
					<div class="tab-header-items text-center" data-navigation="items">
						<router-link :to="{name: 'CardListType', params: { type: 'humo' }}"
							class="navigation-link navigation-link__hover text-decoration-none p-relative text--h4 py-6 font-600 d-inline-block mr-8"
						>
							<I18nVue t="Cards.humo" />
						</router-link>
					</div>
					<div class="tab-header-items text-center" data-navigation="items">
						<router-link :to="{name: 'CardListType', params: { type: 'mastercard' }}"
							class="navigation-link navigation-link__hover text-decoration-none p-relative text--h4 py-6 font-600 d-inline-block mr-8"
						>
							<I18nVue t="Cards.mastercard" />
						</router-link>
					</div>
					<div class="tab-header-items text-center" data-navigation="items">
						<router-link :to="{name: 'CardListType', params: { type: 'bonus' }}"
							class="navigation-link navigation-link__hover text-decoration-none p-relative text--h4 py-6 font-600 d-inline-block mr-5"
						>
							<I18nVue t="Cards.bonuses" />
						</router-link>
					</div>
				</div>
			</v-container>
		...
		<div class="view-toolbar mt-16">
			<v-container class="pa-0">
				<div class="app-tab-header px-5 d-flex">
					<div class="tab-header-items text-center active" data-item="header2">
						<a
							class="navigation-link navigation-link__hover p-relative text--h4 py-6 font-600 d-inline-block mr-8"
						>
							<I18nVue t="Cards.from" />
						</a>
					</div>
					<div class="tab-header-items text-center" data-item="header2">
						<a
							class="navigation-link navigation-link__hover p-relative text--h4 py-6 font-600 d-inline-block mr-8"
						>
							<I18nVue t="Cards.using" />
						</a>
					</div>
					<div class="tab-header-items text-center" data-item="header2">
						<a
							class="navigation-link navigation-link__hover p-relative text--h4 py-6 font-600 d-inline-block mr-8"
						>
							<I18nVue t="Cards.order" />
						</a>
					</div>
					<div class="tab-header-items text-center" data-item="header2">
						<a
							class="navigation-link navigation-link__hover p-relative text--h4 py-6 font-600 d-inline-block mr-5"
						>
							<I18nVue t="Cards.how" />
						</a>
					</div>
		...
		<div class="view-toolbar-content py-15 overflow-hidden">
			<v-container>
				<div class="app-tab-content p-relative">
					<div class="tab-content-items active" data-item="content2">
						<h3 class="font-600 dark-text mb-3">
							<I18nVue t="Cards.plastic.title" />
						</h3>
						<div class="app-ul">
							<ul>
								<li>
									<I18nVue t="Cards.plastic.text1" />
								</li>
								<li>
									<I18nVue t="Cards.plastic.text2" />
								</li>
								<li>
									<I18nVue t="Cards.plastic.text3" />
								</li>
							</ul>
						</div>
						<h3 class="font-600 dark-text mt-5">
							<I18nVue t="Cards.plastic.text4" />
						</h3>
					</div>
					<div class="tab-content-items" data-item="content2">
						<h3 class="font-600 dark-text mb-3">
							<I18nVue t="Cards.advantages.title" />
						</h3>
						<div class="app-ul">
							<ul>
								<li>
									<I18nVue t="Cards.advantages.text1" />
								</li>
								<li>
									<I18nVue t="Cards.advantages.text2" />
								</li>
								<li>
									<I18nVue t="Cards.advantages.text3" />
								</li>
								<li>
									<I18nVue t="Cards.advantages.text4" />
								</li>
								<li>
									<I18nVue t="Cards.advantages.text5" />
								</li>
							</ul>
						</div>
						<h3 class="font-600 dark-text mb-3">
							<I18nVue t="Cards.advantages.text6" />
						</h3>
					</div>
					<div class="tab-content-items" data-item="content2">
						<h3 class="font-600 dark-text mb-3">
					...
					<div class="tab-content-items" data-item="content2">
						...
						<div class="app-ul">
							<ul>
								...
								<li>
									<I18nVue t="Cards.advantages.text7" />
								</li>
								<li>
									<I18nVue t="Cards.advantages.text4" />
								</li>
...
import { appTab, addClass } from "@/utils/frontend";
...
export default {
	...
	mounted() {
		...
		const $tabHeaderItems2 = document.querySelectorAll("[data-item=\"header2\"]");
		const $tabContentItems2 = document.querySelectorAll("[data-item=\"content2\"]");

		appTab($tabHeaderItems2, $tabContentItems2);
