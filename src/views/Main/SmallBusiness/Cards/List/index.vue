			...
			<v-container class="pa-0">
				<div class="app-tab-header px-5 d-flex">
					<div class="tab-header-items text-center" data-navigation="items">
						<router-link :to="{name: 'SmallBusinessCardsListType', params: { type: 'all' }}"
					...
					<div class="tab-header-items text-center" data-navigation="items">
						<router-link :to="{name: 'SmallBusinessCardsListType', params: { type: 'uzcard' }}"
							class="navigation-link navigation-link__hover text-decoration-none p-relative text--h4 py-6 font-600 d-inline-block mr-8"
						>
					...
					<div class="tab-header-items text-center" data-navigation="items">
						<router-link :to="{name: 'SmallBusinessCardsListType', params: { type: 'humo' }}"
							class="navigation-link navigation-link__hover text-decoration-none p-relative text--h4 py-6 font-600 d-inline-block mr-8"
						>
					...
					<div class="tab-header-items text-center" data-navigation="items"
					>
						<router-link :to="{name: 'SmallBusinessCardsListType', params: { type: 'mastercard' }}"
							class="navigation-link navigation-link__hover text-decoration-none p-relative text--h4 py-6 font-600 d-inline-block mr-8"
						>
					...
					<div class="tab-header-items text-center" data-navigation="items">
						<router-link :to="{name: 'SmallBusinessCardsListType', params: { type: 'bonus' }}"
