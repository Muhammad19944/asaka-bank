<template>
    <div class="partner-information-view">
        <v-container>
                        ...
                        <template>
                            ...
                            >
                                <div class="d-flex align-center">
                                    ...
                                    <div class="flex-1">
                                        <h3 class="dark-text font-600">"Asaka" bankiga 21 yil</h3>
                                    </div>
                        ...
                        <template>
                            ...
                            >
                                <div class="d-flex align-center">
                                    ...
                                    <div class="flex-1">
                                        <h3 class="dark-text font-600">BANKEXPO-2016</h3>
                                        <h5 class="font-600 dark-grey">mijoz uchun tezkor, sifatli va foydali</h5>
                                    </div>
