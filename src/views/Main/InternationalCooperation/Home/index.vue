<template>
    <div class="international-view">
        <div class="hero-banner d-flex align-center">
            <v-container>
                <v-row>
                    <v-col md="6" align-self="center" class="dark-text">
                        <h1 class="font-600 text-extra-large mb-2">
                            <I18nVue t='InternationalCooperation.Home.to_financial_institutions'/>
                        </h1>

                        <v-divider style="border-color: rgba(var(--border-color), 1)" class="mt-8 mb-10" />

                        <h4>
                            <I18nVue t='InternationalCooperation.Home.to_financial_institutions_sub'/>
                        </h4>

                        <v-btn depressed color="danger" min-width="192" min-height="50" rounded class="mt-8">
                            <span class="font-700 text-white">
                                <I18nVue t='InternationalCooperation.Home.int_button'/>
                            </span>
                        </v-btn>
                    </v-col>
                    ...
                    <v-col md="5" class="d-none d-md-block">
                        <v-responsive :aspect-ratio="3 / 2.75">
                            <img
                                src="/images/institute_main-slide.png"
                                alt="App logo"
            ...
            <v-container class="p-relative">
                <div class="view-title mb-12">
                    <h1 class="font-600 dark-text align-self-center mb-3">
                        <I18nVue t='InternationalCooperation.Home.important_info'/>
                    </h1>
                </div>
                            ...
                            <div class="d-flex align-center">
                                ...
                                <div>
                                    <h3 class="dark-text font-600">
                                        <I18nVue t='InternationalCooperation.Home.correspondent'/>
                                    </h3>
                                </div>
                            </div>
                        </router-link>
                    ...
                    <v-col lg="4" md="6">
                        ...
                        >
                            <div class="d-flex align-center">
                                ...
                                <div>
                                    <h3 class="dark-text font-600">
                                        <I18nVue t='InternationalCooperation.Home.trade'/>
                                    </h3>
                                </div>
                            </div>
                        </router-link>
                    ...
                    <v-col lg="4" md="6">
                        ...
                        >
                            <div class="d-flex align-center">
                                ...
                                <div>
                                    <h3 class="dark-text font-600">
                                        <I18nVue t='InternationalCooperation.Home.project'/>
                                    </h3>
                                </div>
                            </div>
                        </router-link>
                    ...
                    <v-col lg="4" md="6">
                        ...
                        >
                            <div class="d-flex align-center">
                                ...
                                <div>
                                    <h3 class="dark-text font-600">
                                        <I18nVue t='InternationalCooperation.Home.int_coop'/>
                                    </h3>
                                </div>
                            </div>
                        </router-link>
                    ...
                    <v-col lg="4" md="6">
                        ...
                        >
                            <div class="d-flex align-center">
                                ...
                                <div>
                                    <h3 class="dark-text font-600">
                                        <I18nVue t='InternationalCooperation.Home.world_bank'/>
                                    </h3>
                                </div>
                            </div>
                        </router-link>
                    ...
                    <v-col lg="4" md="6">
                        ...
                        >
                            <div class="d-flex align-center">
                                ...
                                <div>
                                    <h3 class="dark-text font-600">
                                        <I18nVue t='InternationalCooperation.Home.int_contracts'/>
                                    </h3>
                                </div>
                            </div>
                        </router-link>
                    ...
                    <v-col lg="4" md="6">
                        ...
                        >
                            <div class="d-flex align-center">
                                ...
                                <div>
                                    <h3 class="dark-text font-600">
                                        <I18nVue t='InternationalCooperation.Home.treasury'/>
                                    </h3>
                                </div>
                            </div>
                        </router-link>
                    ...
                    <v-col lg="4" md="6">
                        ...
                        >
                            <div class="d-flex align-center">
                                ...
                                <div>
                                    <h3 class="dark-text font-600">
                                        <I18nVue t='InternationalCooperation.Home.useful_info'/>
                                    </h3>
                                </div>
                            </div>
                        </router-link>
        ...
        <section class="partners-section section">
            <v-container>
                ...
                <hooper :settings="hooperSettings" ref="carousel" class="outline-transparent">
                    <slide class="my-8 mx-0 mx-sm-4" style="height: auto">
                        <router-link to="/" class="text-decoration-none d-block h-100">
                            <div class="app-card credit-widget rounded-lg overflow-hidden h-100 d-flex flex-column">
                                <div class="slide-header credit-widget d-flex align-center justify-center">
                                    <img src="/images/partner-1.png" alt="Partner Image" class="transition-all" />
                                </div>
                    ...
                    <slide class="my-8 mx-0 mx-sm-4" style="height: auto">
                        <router-link to="/" class="text-decoration-none d-block h-100">
                            <div class="app-card credit-widget rounded-lg overflow-hidden h-100 d-flex flex-column">
                                <div class="slide-header credit-widget d-flex align-center justify-center">
                                    <img src="/images/partner-2.png" alt="Partner Image" class="transition-all" />
                                </div>
                                <div class="slide-content pa-8">
                    ...
                    <slide class="my-8 mx-0 mx-sm-4" style="height: auto">
                        <router-link to="/" class="text-decoration-none d-block h-100">
                            <div class="app-card credit-widget rounded-lg overflow-hidden h-100 d-flex flex-column">
                                <div class="slide-header credit-widget d-flex align-center justify-center">
                                    <img src="/images/partner-3.png" alt="Partner Image" class="transition-all" />
                                </div>
                                <div class="slide-content pa-8">
                    ...
                    <slide class="my-8 mx-0 mx-sm-4" style="height: auto">
                        <router-link to="/" class="text-decoration-none d-block h-100">
                            <div class="app-card credit-widget rounded-lg overflow-hidden h-100 d-flex flex-column">
                                <div class="slide-header credit-widget d-flex align-center justify-center">
                                    <img src="/images/partner-4.png" alt="Partner Image" class="transition-all" />
                                </div>
                                <div class="slide-content pa-8">
