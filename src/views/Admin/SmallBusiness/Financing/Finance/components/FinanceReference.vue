<template>
  <div class='credit-reference'>
    <v-row>
          ...
          <v-tabs-items v-model="tab1">
            <v-tab-item>
              <div class="app-editor">
                <quill-editor
                    v-model="financeModelReference.text_left_uz"
                    :disabled="TYPE === 'Read'"
                >
                </quill-editor>
              </div>
            ...
            <v-tab-item>
              <div class="app-editor">
                <quill-editor
                    v-model="financeModelReference.text_left_ru"
                    :disabled="TYPE === 'Read'"
                >
                </quill-editor>
              </div>
            ...
            <v-tab-item>
              <div class="app-editor">
                <quill-editor
                    v-model="financeModelReference.text_left_en"
                    :disabled="TYPE === 'Read'"
                >
                </quill-editor>
              </div>
      ...
      <v-col md='4'>
        <div class='app-form-group app-form-group__small no-shadow mb-2'>
          ...
          <v-text-field v-model='financeModelReference.text_right_top_uz' :readonly="TYPE === 'Read'" outlined
                        hide-details>
          </v-text-field>
        </div>
      </v-col>
      ...
      <v-col md='4'>
        <div class='app-form-group app-form-group__small no-shadow mb-2'>
          ...
          <v-text-field v-model='financeModelReference.text_right_top_ru' :readonly="TYPE === 'Read'" outlined
                        hide-details>
          </v-text-field>
        </div>
      </v-col>
      ...
      <v-col md='4'>
        <div class='app-form-group app-form-group__small no-shadow mb-2'>
          ...
          <v-text-field v-model='financeModelReference.text_right_top_en' :readonly="TYPE === 'Read'" outlined
                        hide-details>
          </v-text-field>
        </div>
      </v-col>
      ...
      <v-col md='4'>
        <div class='app-form-group app-form-group__small no-shadow mb-2'>
          ...
          <v-text-field v-model='financeModelReference.text_bottom_uz' :readonly="TYPE === 'Read'" outlined
                        hide-details>
          </v-text-field>
        </div>
      </v-col>
      ...
      <v-col md='4'>
        <div class='app-form-group app-form-group__small no-shadow mb-2'>
          ...
          <v-text-field v-model='financeModelReference.text_bottom_ru' :readonly="TYPE === 'Read'" outlined
                        hide-details>
          </v-text-field>
        </div>
      </v-col>
      ...
      <v-col md='4'>
        <div class='app-form-group app-form-group__small no-shadow mb-2'>
          ...
          <v-text-field v-model='financeModelReference.text_bottom_en' :readonly="TYPE === 'Read'" outlined
                        hide-details>
          </v-text-field>
        </div>
      </v-col>
              ...
              <v-tooltip top color="primary">
                <template v-slot:activator="{ on, attrs }">
                  <v-btn
                      ...
                      :disabled="$store.state.CREATED_FINANCE_ID === null || TYPE === 'Read'"
                      color="primary"
                      large
                      dark
                      v-bind="attrs"
    ...
    <div class='mt-8'>
      <template v-if="$store.state.CREATED_FINANCE_ID">
        <go-back-button/>
...
export default {
  ...
  methods:{
    getAll(){
      this.$http.get(`${this.$store.state.auth.COMPANY_ID}/finance/retail/${this.$store.state.CREATED_FINANCE_ID}/reference/`)
          .then(({ data  }) => {
    ...
    * */
    send() {
      this.$http.post(`/${this.$store.state.auth.COMPANY_ID}/finance/retail/${this.$store.state.CREATED_FINANCE_ID}/reference/`, this.financeModelReference)
          .then(({ data }) => {
            this.$toast.success('Yaratildi')

            this.financeModelReference = data
    ...
    * */
    update() {
      this.$http
          .put(
              `/${this.$store.state.auth.COMPANY_ID}/finance/retail/${this.$store.state.CREATED_FINANCE_ID}/reference/${this.financeModelReference.id}/`,
              this.financeModelReference
          )
          .then((res) => {
    ...
    * */
    getOneProp() {
      this.$http.get(`/${this.$store.state.auth.COMPANY_ID}/finance/retail/${this.$store.state.CREATED_FINANCE_ID}/reference/`)
          .then(({ data }) => {
            this.financeModelReference = data.results.length > 0 ? data.results[0] : {}
    ...
    * */
    propUpdate(item) {
      this.financeModelReference = { ...item };
    },
    /*
    *
    * */
    deleteProp(id) {
      ...
      this.$http
          .delete(`/${this.$store.state.auth.COMPANY_ID}/finance/retail/${this.$store.state.CREATED_FINANCE_ID}/reference/${id}/`)
          .then((res) => {
