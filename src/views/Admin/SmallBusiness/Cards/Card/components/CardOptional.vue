			...
			<v-col md="12">
				<div class="admin-tabs">
					...
					<v-tabs-items v-model="tab2">
						<v-tab-item>
							<div class="app-editor">
								<quill-editor v-model="plasticCardsModel.condition_uz" :disabled="TYPE === 'Read'">
								</quill-editor>
							</div>
						</v-tab-item>
						...
						<v-tab-item>
							<div class="app-editor">
								<quill-editor v-model="plasticCardsModel.condition_ru" :disabled="TYPE === 'Read'">
								</quill-editor>
							</div>
						</v-tab-item>
						<v-tab-item>
							<div class="app-editor">
								<quill-editor v-model="plasticCardsModel.condition_en" :disabled="TYPE === 'Read'">
								</quill-editor>
							</div>
						</v-tab-item>
					</v-tabs-items>
...
export default {
	...
	methods: {
		...
		getOne() {
			...
			this.$http.get(`/${this.$store.state.auth.COMPANY_ID}/plastic_cards/${this.$store.state.CREATED_CARD_ID}/`).then(({ data }) => {
