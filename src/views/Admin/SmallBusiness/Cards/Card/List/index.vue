	    ...
	    >
		    <template slot-scope="{ filters, list, count, loading, getAll, deleteRow, paginate }">
			    <div class="d-flex flex-column h-100">
				    ...
				    >
					    <template #add-view>
						    <v-btn :to="{ name: 'AdminSmallBusinessCardsListCreate' }" depressed color="primary">
							    ...
							    <tbody>
								    <tr class="transition-fast-out-slow-in" v-for="item in list" :key="item.id">
									    ...
									    <td class="admin-table-td" width="160">
										    <v-btn
											    :to="{ name: 'AdminSmallBusinessCardsRead', params: { id: item.id } }"
											    depressed
											    icon
											    color="info"
										    >
										    ...
										    <v-btn
											    :to="{ name: 'AdminSmallBusinessCardsUpdate', params: { id: item.id } }"
											    depressed
											    icon
											    color="warning"
											    class="mx-2"
