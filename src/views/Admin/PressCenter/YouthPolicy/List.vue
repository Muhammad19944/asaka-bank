<template>
	<div class="news-view">
		<div class="d-flex align-center mb-5">
			<h5 class="app-card-title font-600 text-secondary-dark">{{ $t('Dashboard.sidebar.young_policy.young_policy_text') }}</h5>

			<v-spacer />

			<v-btn :to="{ name: 'DashboardYoungPolicyCreate' }" depressed color="primary">
						...
						<v-col md="4" :key="item.id">
							...
							>
								<div class="app-card-header p-relative">
									...
									>
										<router-link
											:to="{ name: 'DashboardYoungPolicyRead', params: { id: item.id } }"
											type="button"
											class="
                                                rounded-circle
                                                d-flex
										...
										<router-link
											:to="{ name: 'DashboardYoungPolicyUpdate', params: { id: item.id } }"
											type="button"
											class="
                                                rounded-circle
                                                d-flex
