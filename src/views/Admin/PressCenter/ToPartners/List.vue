<template>
  <div class="news-view">
    <div class="d-flex align-center mb-5">
      <h5 class="app-card-title font-600 text-secondary-dark">Hamkorlarga</h5>

      <v-spacer />

      <v-btn :to="{ name: 'DashboardToPartnersCreate' }" depressed color="primary">
            ...
            <v-col md="4" :key="index">
              ...
              >
                <div class="app-card-header p-relative">
                  ...
                  >
                    <router-link
                        :to="{ name: 'DashboardToPartnersRead', params: { id: item.id } }"
                        type="button"
                        class="
                                                rounded-circle
                                                d-flex
                    ...
                    <router-link
                        :to="{ name: 'DashboardToPartnersUpdate', params: { id: item.id } }"
                        type="button"
                        class="
                                                rounded-circle
                                                d-flex
