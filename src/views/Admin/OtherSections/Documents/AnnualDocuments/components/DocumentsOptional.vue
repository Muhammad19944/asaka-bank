			...
			<v-row>
				<v-col md='4'>
					<div class='app-form-group app-form-group__small no-shadow mb-2'>
						<h5 class='font-600 dark-text mb-1'>Hujjat mavzusi (UZ)</h5>
				...
				<v-col md='4'>
					<div class='app-form-group app-form-group__small no-shadow mb-2'>
						<h5 class='font-600 dark-text mb-1'>Hujjat mavzusi (RU)</h5>
				...
				<v-col md='4'>
					<div class='app-form-group app-form-group__small no-shadow mb-2'>
						<h5 class='font-600 dark-text mb-1'>Hujjat mavzusi (EN)</h5>
		...
		methods:{
			send(){
				...
				.then(({ data }) => {
					...
					this.$store.state.CREATED_ANNUAL_DOCUMENT_ID = data.id;
			...
			* */
			update(){
				...
				this.$http.put(`${this.$store.state.auth.COMPANY_ID}/bank/finance_indication_title/${this.$store.state.CREATED_ANNUAL_DOCUMENT_ID}`, this.documentsModel)
				.then((response) => {
			...
			* */
			getOne(){
				...
				this.$http.get(`${this.$store.state.auth.COMPANY_ID}/bank/finance_indication_title/${this.$store.state.CREATED_ANNUAL_DOCUMENT_ID}`)
				.then(({ data }) => {
