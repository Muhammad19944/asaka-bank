		...
		<v-row class="mb-4">
			...
			<v-col md="12">
				<div class="admin-tabs">
					...
					>
						<v-tab class="transition-ease-in-out">
							<h5 class="font-600 dark-text text-transform-reset no-spacing px-2">Kredit davri <span class="font-700 text-small">(UZ)</span></h5>
						</v-tab>
						<v-tab class="transition-ease-in-out">
							<h5 class="font-600 dark-text text-transform-reset no-spacing px-2">Kredit davri <span class="font-700 text-small">(RU)</span></h5>
						</v-tab>
						<v-tab class="transition-ease-in-out">
							<h5 class="font-600 dark-text text-transform-reset no-spacing px-2">Kredit davri <span class="font-700 text-small">(EN)</span></h5>
						</v-tab>
					</v-tabs>
					<v-tabs-items v-model="tab3">
						<v-tab-item>
							<div class="app-editor">
								<quill-editor
									v-model="creditModel.credit_period"
									:disabled="TYPE === 'Read'"
									class="edit-height-100"
								>
								</quill-editor>
						...
						<v-tab-item>
							<div class="app-editor">
								<quill-editor
									v-model="creditModel.credit_period_ru"
									:disabled="TYPE === 'Read'"
									class="edit-height-100"
								>
								</quill-editor>
						...
						<v-tab-item>
							<div class="app-editor">
								<quill-editor
									v-model="creditModel.credit_period_en"
									:disabled="TYPE === 'Read'"
									class="edit-height-100"
								>
								</quill-editor>
	...
	methods: {
		...
		* */
		send() {
			...
			this.$http.post('/1/credit/', this.creditModel)
			.then(({ data }) => {
