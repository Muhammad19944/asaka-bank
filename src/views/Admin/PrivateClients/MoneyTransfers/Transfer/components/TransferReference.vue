<template>
	<div class='credit-reference'>
		<v-row>
					...
					<v-tabs-items v-model="tab1">
						<v-tab-item>
							<div class="app-editor">
								<quill-editor
									v-model="transferModelReference.text_left_uz"
									:disabled="TYPE === 'Read'"
								>
								</quill-editor>
							</div>
						...
						<v-tab-item>
							<div class="app-editor">
								<quill-editor
									v-model="transferModelReference.text_left_ru"
									:disabled="TYPE === 'Read'"
								>
								</quill-editor>
							</div>
						...
						<v-tab-item>
							<div class="app-editor">
								<quill-editor
									v-model="transferModelReference.text_left_en"
									:disabled="TYPE === 'Read'"
								>
								</quill-editor>
							</div>
			...
			<v-col md='4'>
				<div class='app-form-group app-form-group__small no-shadow mb-2'>
					...
					<v-text-field v-model='transferModelReference.text_right_top_uz' :readonly="TYPE === 'Read'" outlined
					              hide-details>
					</v-text-field>
				</div>
			</v-col>
			...
			<v-col md='4'>
				<div class='app-form-group app-form-group__small no-shadow mb-2'>
					...
					<v-text-field v-model='transferModelReference.text_right_top_ru' :readonly="TYPE === 'Read'" outlined
					              hide-details>
					</v-text-field>
				</div>
			</v-col>
			...
			<v-col md='4'>
				<div class='app-form-group app-form-group__small no-shadow mb-2'>
					...
					<v-text-field v-model='transferModelReference.text_right_top_en' :readonly="TYPE === 'Read'" outlined
					              hide-details>
					</v-text-field>
				</div>
			</v-col>
			...
			<v-col md='4'>
				<div class='app-form-group app-form-group__small no-shadow mb-2'>
					...
					<v-text-field v-model='transferModelReference.text_bottom_uz' :readonly="TYPE === 'Read'" outlined
					              hide-details>
					</v-text-field>
				</div>
			</v-col>
			...
			<v-col md='4'>
				<div class='app-form-group app-form-group__small no-shadow mb-2'>
					...
					<v-text-field v-model='transferModelReference.text_bottom_ru' :readonly="TYPE === 'Read'" outlined
					              hide-details>
					</v-text-field>
				</div>
			</v-col>
			...
			<v-col md='4'>
				<div class='app-form-group app-form-group__small no-shadow mb-2'>
					...
					<v-text-field v-model='transferModelReference.text_bottom_en' :readonly="TYPE === 'Read'" outlined
					              hide-details>
					</v-text-field>
				</div>
			</v-col>
		...
		<div class='mt-8'>
			<template v-if="$store.state.CREATED_TRANSFER_ID">
				<go-back-button />
...
<script>
	...
	export default {
		...
		methods: {
			getAll(){
				this.$http.get(`${this.$store.state.auth.COMPANY_ID}/transfer/${this.$store.state.CREATED_TRANSFER_ID}/reference/`)
					.then(({ data  }) => {
			...
			* */
			send() {
				this.$http.post(`/${this.$store.state.auth.COMPANY_ID}/transfer/${this.$store.state.CREATED_TRANSFER_ID}/reference/`, this.transferModelReference)
					.then(({ data }) => {
			...
			update() {
				this.$http
					.put(
						`/${this.$store.state.auth.COMPANY_ID}/transfer/${this.$store.state.CREATED_TRANSFER_ID}/reference/${this.transferModelReference.id}/`,
						this.transferModelReference
					)
					.then((res) => {
			...
			* */
			propUpdate(item) {
				this.transferModelReference = { ...item };
			},
			/*
			*
			* */
			deleteProp(id) {
				...
				this.$http
					.delete(`/${this.$store.state.auth.COMPANY_ID}/transfer/${this.$store.state.CREATED_TRANSFER_ID}/reference/${id}/`)
					.then((res) => {
